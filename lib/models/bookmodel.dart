...
class Book {
  ...
  factory Book.fromJson(Map<String, dynamic> json) {
    var volumeInfo = json['volumeInfo'] ?? {};//volumeInfo is map that is present in json file
    return Book(
      id: json['id'] ?? '',
      title: volumeInfo['title'] ?? '',
      authors: (volumeInfo['authors'] as List<dynamic>? ?? [])//authors is a list in json file
          .map((author) => author.toString())
          .toList(),
      publisher: volumeInfo['publisher'] ?? '',
      publishedDate: volumeInfo['publishedDate'] ?? '',
      description: volumeInfo['description'] ?? '',
      industryIdentifiers: {//industry identifier is a map in json file
        for (var item
      ...
      imageLinks: (volumeInfo['imageLinks'] as Map<String, dynamic>? ?? {})//imageLinks is a map in json file
  ...
  // for saving to db
  //it is using json varibales on left most
  ...
  // for loading from db
  //it is using this file variables on left side
  ...
  String toString() {
    ...
    return "Book: ${this.title} isFavorite: ${this.isFavorite}";
  }
}